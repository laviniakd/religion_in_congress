...
#    python /home/laviniad/projects/religion_in_congress/src/llm_experiments/add_llm_outputs_br.py --hf_model $MODEL
#done
...
do
    ...
    do
        ...
        python /home/laviniad/projects/religion_in_congress/src/llm_experiments/add_llm_outputs_br.py --hf_model $MODEL --sample --temperature $TEMPERATURE
    done
done