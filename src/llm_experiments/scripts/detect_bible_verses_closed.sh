...
#    python /home/laviniad/projects/religion_in_congress/src/llm_experiments/add_closed_llm_outputs_br.py --model $MODEL
#done
...
do
    ...
    do
        ...
        python /home/laviniad/projects/religion_in_congress/src/llm_experiments/add_closed_llm_outputs_br.py --model $MODEL --sample --temperature $TEMPERATURE
    done
done
